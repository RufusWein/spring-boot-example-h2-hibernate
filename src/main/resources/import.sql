...
// CREATE TABLE USER(ID INT PRIMARY KEY, USERNAME VARCHAR, PASSWORD VARCHAR, FIRTSNAME VARCHAR, LASTNAME VARCHAR, COUNTRY VARCHAR, ROLE VARCHAR);

// ALTER TABLE USER ADD UNIQUE (ID, USERNAME);